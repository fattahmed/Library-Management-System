...
import LSMProject.controller.conn;
import LSMProject.view.Home;
/**
 *
 * @author fattahmed
 */
public class BookDetails extends JFrame implements ActionListener{
	...
	ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("LSMProject/icons/eight.png"));
	...
	ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("LSMProject/icons/nineth.png"));
	...
	ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("LSMProject/icons/tenth.png"));
